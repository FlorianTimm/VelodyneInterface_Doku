...
\paragraph{VdASCIIFile (VdTxtFile / VdObjFile / VdXYZFile)}
...
Die Konfiguration der IP-Adressen für den Raspberry Pi erfolgt in der Konfigurationsdatei \code{/etc/network/interfaces} (siehe \autoref{interfaces}. \cite{accesspoint}
