...
Die grundlegenden Einstellungen erfolgen über die Konfigurationsdatei \code{config.ini}. Hier können Einstellungen zum Verhalten des Skript durchgeführt werden, aber auch die Parameter des Laserscanners angepasst werden.
\todo{weiter, zB auch Bedienung}

\section{Weitere Geschwindigkeitsoptimierung}
Tests ergaben, dass die Speicherung und Umwandlung nun alle Daten vom Scanner erfassen kann. Jedoch dauerte die Umwandlung der Daten im Dual-Return-Modus etwa die zehnfache Zeit der Messdauer auf einem Office-Notebook (2x 2,4 GHz, 8GB RAM)
\todo{weiter}
