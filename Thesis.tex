...
\todo{sudo rpi-update}
\todo{sudo apt update}
\todo{sudo apt upgrade}
\todo{sudo apt-get install python3-pip}
\todo{pip3 install flask}
\todo{pip3 install pyserial}
\todo{pip3 install RPi.GPIO}
\todo{Lokalisation}
...
\lstinputlisting[language=C++]{../Quelltext/arduino/ppsVergleich.ino}
