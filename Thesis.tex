...
\begin{figure}[!ht]
 \centering
 \includegraphics[width=1\textwidth]{./img/Ablaufplan.png}
 % Strahlengang.eps: 0x0 pixel, 300dpi, 0.00x0.00 cm, bb=0 0 3066 4000
...
\begin{figure}[!ht]
 ...
 \caption{Protyp des Messsystemes, Betrieb noch ohne Akkumulatoren}
 \label{abb:system}
\end{figure}
